...
public sealed record AudioItem(string SourcePath, bool IsTemporaryFile)
{
    ...
    public static AudioItem FromFile(string path)
    {
        return new AudioItem(path, false);
    }
    ...
    /// <returns>A new AudioItem instance.</returns>
    public static AudioItem FromTempFile(string path)
    {
        return new AudioItem(path, true);
    }
